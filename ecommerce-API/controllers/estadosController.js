...
exports.obtenerEstadoPorId = async (req, res) => {
  ...
  try {
    ...
    res.status(500).send({ mensaje: "Error al buscar el estado" }, { error: err });
  }
};
...
exports.agregarEstado = async (req, res) => {
  ...
  try {
    ...
    res.status(500).send({ mensaje: "Error al insertar el estado" }, { error: err });
  }
};
...
exports.actualizarEstado = async (req, res) => {
  ...
  try {
    ...
    res.status(500).send({ mensaje: "Error al actualizar el estado" }, { error: err });
  }
};
...
exports.eliminarEstado = async (req, res) => {
  ...
  try {
    ...
    res.status(500).send({ mensaje: "Error al eliminar el estado" }, { error: err });
  }
};
